import { Pointer } from '@/components/global/cursor'
import { motion } from 'framer-motion'
import { cn } from '@/lib/utils'

export const Example = () => (
  <div className={'flex h-screen w-full flex-col justify-between rounded-lg dark:bg-black dark:text-white'}>
    <div className="flex h-full w-full flex-col justify-center px-4 text-start sm:items-center sm:text-center">
      <div className="text-6xl font-bold">Automation Web Development.</div>
      <div className="text-lg dark:text-neutral-400">Hover over the illustration and you gonna see</div>
    </div>
    <Pointer name="Vicky" className={'relative flex h-fit w-full items-end justify-center'}>
      <div className={'relative h-[400px] w-full overflow-hidden'}>
        <div className="relative flex h-full w-full justify-end pt-4">
          <AnimatedCursor text="Harkesh" />
...
const AnimatedCursor: React.FC<{ className?: string; text: string }> = ({ className, text }) => (
  <motion.div
    ...
    <svg fill="red" height="18" viewBox="0 0 17 18" width="17">
      <path
