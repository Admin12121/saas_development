...
import DesignerSidebar from "@/pages/site-management/app/formbuilder/components/DesignerSidebar";
    ...
    <TooltipProvider delayDuration={0}>
      ...
      >
        <ResizablePanel
          ...
          className={cn('p-2 pr-[5px] max-md:hidden',
            isCollapsed &&
        ...
        <ResizablePanel defaultSize={defaultLayout[1]} minSize={30} className="p-2 pl-[5px] overflow-hidden overflow-y-auto h-full">
          {children}
        </ResizablePanel>
      </ResizablePanelGroup>
    </TooltipProvider>
